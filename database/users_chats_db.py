...
# MODIFIED: Imported DATABASE_NAME1 and DATABASE_URI1 instead of the old names.
from info import (IS_VERIFY, LINK_MODE, FILE_CAPTION, TUTORIAL, DATABASE_NAME1, DATABASE_URI1, 
                  IMDB, IMDB_TEMPLATE, PROTECT_CONTENT, AUTO_DELETE, SPELL_CHECK, AUTO_FILTER, 
                  LOG_VR_CHANNEL, SHORTENER_WEBSITE, SHORTENER_API, SHORTENER_WEBSITE2, 
                  SHORTENER_API2, TWO_VERIFY_GAP)

# MODIFIED: Connected to the primary database using the new variable names.
client = AsyncIOMotorClient(DATABASE_URI1)
mydb = client[DATABASE_NAME1]
...
class Database:
    ...
    async def get_expired(self, current_time):
        ...
        try:
            ...
            print(f"Error finding expired users: {e}")
