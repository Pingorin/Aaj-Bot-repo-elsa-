...
class Database:
    ...
    async def add_join_req(self, user_id, chat_id):
        ...
        # upsert=True ka istemal karein taaki duplicate entries na banein
    ...
    async def del_join_req(self):
        """Sirf saare documents delete karein, collection ko drop na karein"""
