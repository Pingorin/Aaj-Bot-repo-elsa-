...
# FIX: AUTH_CHANNEL ko yahan se hata diya gaya hai
from info import LONG_IMDB_DESCRIPTION, IS_VERIFY
from imdb import Cinemagoer
import asyncio
# FIX: Unused import hata diya gaya
# import shortzy 
...
class temp(object):
    ...
    GROUPS_CANCEL = False    
    CHAT = {}
    # FIX: bot.py ke liye yeh zaroori hai
    BANNED_USERS = []
    BANNED_CHATS = []

# FIX: Pooraana is_req_subscribed function delete kar diya gaya hai
# Kyunki naya logic ab Join_req.py mein hai.
