...
# FIX 1: 'AUTH_CHANNEL' ko yahan se hata diya gaya hai
...
# FIX 2: Poora 'is_req_subscribed' function delete kar diya gaya hai, 
# kyunki yeh ab commands.py mein handle ho raha hai.
