...
When <b>{target}</b> users join Telegram using your link, you'll get permanent direct access to all files without any verification!

Your current referral count: <b>{count} / {target}</b>
"""
...
You've successfully referred <b>{target}</b> users. You now have permanent direct access to all files without any verification!"""
