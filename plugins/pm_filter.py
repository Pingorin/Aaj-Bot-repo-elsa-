...
from info import (
    ...
    REFERRAL_TARGET, REQ_AUTH_CHANNEL  # REQ_AUTH_CHANNEL bhi import kar liya hai
)
...
lock = asyncio.Lock()
logger = logging.getLogger(__name__) # Logger initialized hai
...
async def next_page(bot, query):
    ...
    # FIX: Add 'Refer & Earn' Button (Updated to URL)
    btn.append(
