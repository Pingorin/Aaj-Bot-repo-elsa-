...
from info import (
    ...
    REFERRAL_TARGET, REQ_AUTH_CHANNEL # REQ_AUTH_CHANNEL import karein
)
...
async def pm_search(client, message):
    # F-Sub check yahaan se hata diya gaya hai, ab yeh commands.py mein hai
    if IS_PM_SEARCH:
...
async def group_search(client, message):
    ...
    # F-Sub check yahaan se hata diya gaya hai
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # --- FIX: YEH BLOCK PURANA HAI AUR CONFLICT KAREGA ---
    # --- ISE DELETE KAR DEIN ---
    ...
    #         )
    #     )
    # --- PURANA BLOCK YAHAN KHATAM HOTA HAI ---
