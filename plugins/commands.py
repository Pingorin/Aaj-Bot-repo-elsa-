...
async def start(client:Client, message): 
    ...
    # --- NAYA FSUB CHECK (Member OR Pending Request) V3 ---
    ...
    # Pehle, dono channels ke liye 'pass' status ko False set karein
    pass_1 = False
    pass_2 = False
    ...
    # Agar user dono channels ko pass kar leta hai, toh aage badhein
...
async def delete_all_index(bot, message):
    ...
    if message.from_user.id not in ADMINS:
        await message.reply('ᴏɴʟʏ ᴛʜᴇ ʙᴏᴛ ᴏᴡɴᴇR ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴḍ... 😑')
        return
