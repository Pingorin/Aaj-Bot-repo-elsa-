...
from info import (
    ...
    REQ_SUB_CHANNEL_1, REQ_SUB_CHANNEL_2
)
...
async def start(client:Client, message): 
    ...
    # --- NAYA JOIN REQUEST FSUB BLOCK (FIXED) ---
    ...
    if not has_req_1 or not has_req_2:
        ...
        # --- FIX: YAHAN SE BUGGY 'callback_data' LOGIC HATA KAR SIRF 'url' WALA BUTTON RAKHA HAI ---
        # Isse 'checksub' bug fix ho jayega aur verification dobara trigger hoga.
