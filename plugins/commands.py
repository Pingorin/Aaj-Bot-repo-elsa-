...
# ... inside the start function
    ...
    if not await db.has_premium_access(user_id):
        ...
        if settings.get("is_verify", IS_VERIFY) and not user_verified or is_second_shortener:
            ...
            try:
                # 1. Attempt to generate the verification link
                ...
                # 3. Create a list for the first row of buttons and add the verified link
                first_row = [InlineKeyboardButton(text="✅️ ᴠᴇʀɪғʏ ✅️", url=verify_url)]

                # 4. Validate the tutorial URL before adding its button
                ...
                # 5. Build the final button layout
                buttons = [
                    first_row,
                ...
                # 6. Catch any other unexpected errors and inform the user
...
# ... (rest of the Command.py file remains unchanged)
