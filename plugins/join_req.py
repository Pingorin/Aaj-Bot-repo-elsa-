...
from info import ADMINS, REQ_SUB_CHANNEL_1, REQ_SUB_CHANNEL_2  # <-- FIX 1: Naye channels import karein
...
async def join_reqs(client, message: ChatJoinRequest):
  ...
  # FIX 2: find_join_req ko user_id aur chat_id dono pass karein
  if not await db.find_join_req(message.from_user.id, message.chat.id):
      
      # FIX 3: add_join_req ko user_id aur chat_id dono pass karein
