...
auth_channel = environ.get('AUTH_CHANNEL', '-1003244733972')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# --- ADDED THIS BLOCK ---
# New FSub channel
req_auth_channel = environ.get('REQ_AUTH_CHANNEL', '-1003295790341') # Change '0' to your channel ID
REQ_AUTH_CHANNEL = int(req_auth_channel) if req_auth_channel and id_pattern.search(req_auth_channel) else None
# --- END OF ADDED BLOCK ---
