...
# -------------------- DUAL DATABASE CONFIGURATION (UPDATED) --------------------

# Primary Database (Your original DB)
DATABASE_URI1 = environ.get('DATABASE_URI1', environ.get('DATABASE_URI', ""))
DATABASE_NAME1 = environ.get('DATABASE_NAME1', environ.get('DATABASE_NAME', ""))

# Secondary Database (Your new DB)
